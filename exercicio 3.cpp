...
int insereVetor(int element, int valueMax, int lastPos, int Vetor[]){
  Vetor[lastPos + 1] = element;
  if(lastPos +1 >= valueMax){
    
    cout << "Erro: valorMax: " << valueMax << "lastPos + 1 (indice): " << valueMax <<endl;
  }
